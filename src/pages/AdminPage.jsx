        ...
        {activeTab === 'inventory' ? (
          ...
          <div className="card">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              ...
              <button className="btn btn-secondary" onClick={onRefreshRequests} style={{ padding: '0.4rem 0.8rem', fontSize: '0.8rem' }}>
                Refresh Data
              </button>
            </div>
                          ...
                          <div style={{ display: 'flex', gap: '0.5rem' }}>
                            {req.status === 'pending' && (
                              <button 
                                ...
                                style={{ padding: '0.3rem 0.6rem', fontSize: '0.75rem', background: '#3498db' }}
                                onClick={() => onUpdateRequestStatus(req.id, 'matched')}
                              >
                                Match
                              </button>
                            )}
                            {(req.status === 'pending' || req.status === 'matched') && (
                              <button 
                                className="btn btn-primary" 
                                style={{ padding: '0.3rem 0.6rem', fontSize: '0.75rem', background: '#27ae60' }}
